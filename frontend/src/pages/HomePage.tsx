    ...
    <div>
      ...
      <section className="relative bg-gradient-to-b from-primary-950 via-zinc-950 to-zinc-950 dark:from-primary-950/80 dark:via-zinc-900 dark:to-zinc-900 overflow-hidden -mt-14">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-28 sm:py-36 lg:py-44">
          ...
          {/* Metrics strip */}
          <div className="mt-20 flex items-center justify-center animate-slide-up">
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'Track every application in real-time. Know exactly where you stand â€” no black holes.',
              },
              {
              ...
              <div
                key={f.title}
                className="group relative p-6 rounded-2xl border border-ink-900/[0.06] hover:border-ink-900/[0.12] transition-all duration-200"
              >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="group relative p-6 rounded-2xl border border-ink-900/[0.06] hover:border-ink-900/[0.12] bg-card hover:bg-surface-50/50 dark:hover:bg-surface-100/50 transition-all duration-200">
            ...
            <div className="relative rounded-3xl bg-gradient-to-br from-primary-950 via-zinc-950 to-zinc-900 overflow-hidden px-8 sm:px-16 py-16 sm:py-20 text-center">
              ...
              <div className="relative">
                ...
                <p className="mt-4 text-body-lg text-white/40 max-w-md mx-auto">
                  Join thousands of professionals who found their next opportunity through JobBoard.
                </p>
